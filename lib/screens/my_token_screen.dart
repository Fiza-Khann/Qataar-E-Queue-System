...
@override
  void initState() {
    ...
    // Safely init location in initState (optional)
  }
              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, tokenSnap) {
                    ...
                    if (tokenSnap.data!.docs.isEmpty) {
                      return Center(
                        child: Text(
                      ...
                      builder: (context, currentSnap) {
                        ...
                        return StreamBuilder<DocumentSnapshot>(
                          ...
                          builder: (context, serviceSnap) {
                            ...
                            if (currentSnap.hasData &&
                                currentSnap.data!.docs.isNotEmpty) {
                              final currentStartTime = (currentSnap.data!.docs.first['bookingTime'] as Timestamp).toDate();
                              final elapsed =
